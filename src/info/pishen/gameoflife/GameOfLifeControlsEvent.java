...
public class GameOfLifeControlsEvent extends Event {
	 ...
	 */
	public static GameOfLifeControlsEvent getSpeedChangedEvent(Object source,
			int speed) {
	 ...
	 *            source of the event
	 * @param zoom
	 *            new zoom (cell size in pixels)
	 * @return new event object
	 */
	public static GameOfLifeControlsEvent getZoomChangedEvent(Object source,
			int zoom) {
		GameOfLifeControlsEvent event = new GameOfLifeControlsEvent(source);
		event.setZoom(zoom);
		return event;
	 ...
	 * @return new event object
	 */
	public static GameOfLifeControlsEvent getShapeSelectedEvent(Object source,
			String shapeName) {
		GameOfLifeControlsEvent event = new GameOfLifeControlsEvent(source);
